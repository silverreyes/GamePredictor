# Requirements Archive: v1.1 Point Spread Model
...
- [x] **PIPE-02**: Seed script generates historical spread predictions for completed games (2023 validation season)
- [x] **PIPE-03**: All changes deployed to production VPS at nostradamus.silverreyes.net
